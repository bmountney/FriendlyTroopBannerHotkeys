...
namespace FriendlyTroopBannerHotkeys
{
    public class FriendlyTroopBannerHotkeysModSettings : AttributeGlobalSettings<FriendlyTroopBannerHotkeysModSettings>
    {
        ...
        [SettingPropertyDropdown("{=ToggleHotkey}Banner Toggle Hotkey", Order = 10, RequireRestart = false, HintText = "{=ToggleHotkeyHint}This hotkey will toggle the banner visibilty, allowing you to invert the 'Banners are On by Default' option while in battle. Default is the [Right Alt] key.")]
        [SettingPropertyGroup("{=Main}Enable Hotkeys", GroupOrder = 0)]
